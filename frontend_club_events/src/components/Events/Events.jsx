...
const Events = () => {
  ...
  const [rateMessageVisible, setRateMessageVisible] = useState({});
  ...
  const toggleFeedbackFormVisibility = (eventId) => {
          ...
          <div key={index} className="card">
            ...
            <div className="card-content">
              ...
              <h3>{event.event_title}</h3>
                ...
                {presidentConfirmed.has(event.event_id) &&
                !ratedEvents.has(event.event_id) && (
                    <span
              ...
              {showFeedbackForm && currentEventId === event.event_id && (
                <div className="modal">
                  <div className="modal-content">
                    <span
                      className="close"
                      onClick={() => toggleFeedbackFormVisibility(null)}
                    >
                      &times;
                    </span>
                    ...
                    >
                      <label className="rn" htmlFor="rating_number">
                        Rating Number
                      </label>
